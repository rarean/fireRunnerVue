  ...
  data: function () {
    return {
      ...
      inputs: [
        {
          label: "Standby",
          mutate: "updateStandby"
        },
        {
          label: "Equipment Stolen",
          mutate: "updateEquipStolen"
        },
        {
          label: "Equipment Lost",
          mutate: "updateEquipLost"
        },
        {
          label: "Equipment Broken",
          mutate: "updateEquipBroken"
        },
        {
          label: "Receipts Bagged",
          mutate: "updateReceiptsBagged"
        },
        {
          label: "Truck Restocked",
          mutate: "updateTruckRestocked"
        }
      ]
    };
  },
